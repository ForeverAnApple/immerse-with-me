...
export function HomePage() {
  ...
  return (
    <div className="relative min-h-screen w-full bg-[#F5E6D3] text-[#1A1A1A] font-sans selection:bg-indigo-100 selection:text-indigo-900">
      {/* Font Import */}
      <style>{`
      ...
      {/* Sticky Header */}
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-black/5 bg-[#F5E6D3]/80 px-6 backdrop-blur-md">
      ...
      >
        ...
        >
          ...
          <div className="relative space-y-3">
            ...
            <div className="pointer-events-none absolute bottom-0 left-0 right-0 h-24 bg-gradient-to-t from-[#F5E6D3] to-transparent z-20" />
