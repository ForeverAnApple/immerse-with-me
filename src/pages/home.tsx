      ...
      <header className="sticky top-0 z-50 flex h-16 items-center justify-between border-b border-border bg-background/80 px-6 backdrop-blur-md">
        ...
        <div className="flex items-center gap-6">
          <div className="flex items-center gap-4">
            <button className="text-muted-foreground transition-colors hover:text-foreground" aria-label="Discord">
            ...
            <button className="text-muted-foreground transition-colors hover:text-foreground" aria-label="GitHub">
              <svg
            ...
            >
              <Card className={cn("relative overflow-hidden border border-border bg-card shadow-sm transition-all hover:shadow-md", stat.border)}>
                ...
                <CardContent className="relative p-8 text-center">
                  ...
                  <div className="font-serif-jp text-4xl font-bold text-card-foreground tabular-nums">
                    {stat.value}
                  </div>
